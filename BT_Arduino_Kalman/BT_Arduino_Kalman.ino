...
/* 
 * 2021/9/12 --------- 用于Nano板，设定为D2左键，D3右键，D4鼠标开关。
 * 
 * 参数可根据自己需要调节
 */
...
/* IMU Data */
double accX, accY, accZ;  // The accelerated speed of each axis.
double gyroX, gyroY, gyroZ;  // The angular acceleration (by?) each axis.
int16_t tempRaw;
...
{   // Set I2C frequency
    ...
    // TODO: Different parameter to get differnt data;
